...
def circle(features, frames, wait=1, high_contrast=True, write_file=None):
    ...
    frames : iterable container of image arrays, like a list of
        images or a Video object (See pims.video.Video.)
    ...
    if write_file is not None:
        try:
            ...
            raise ValueError("To use write_file, frames must " +
                             "be a subclass of Frames.")
